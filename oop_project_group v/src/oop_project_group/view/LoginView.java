...
public class LoginView  extends JComponent{
   //objects
    ...
    public LoginView() {
        ...
        labelUserName.setBounds(150,130, 70, 60);
        
        userNameField = new JTextField( 20 ); // user field
        userNameField.setBounds(295, 158, 200, 25);
       
        
        
        labelUserPassword = new JLabel ("Password: "); // password label
        labelUserPassword.setBounds(150, 190, 90, 90);
        ...
        buttonLogin.setBounds(280, 330, 78, 30);
